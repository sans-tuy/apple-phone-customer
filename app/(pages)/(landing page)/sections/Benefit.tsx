      ...
      <motion.div className="mt-32 gap-x-10 px-10 grid w-full grid-cols-1 lg:grid-cols-2 lg:px-60">
        ...
        >
          ...
          <p className="text-base w-[330px] lg:w-[500px]">
            In addition to the benefits above, there are also internal benefits
            that you will get if you buy a Smartphone compared to other
            Smartphones
          </p>
          ...
          <div className="flex gap-x-4">
            ...
            <p className="text-base">
              We gives you the best prices with high quality for any needed such
              as gaming, photography or for professional purposes.
            </p>
          </div>
          ...
          <div className="flex gap-x-4">
            ...
            />
            <p className="text-base">
              Up to 30% performance improvement, increasing responsiveness up to
              20%. Make gameplay richer with 35% faster graphics rendering.
            </p>
          </div>
