...
import GLTFModel from "@components/ModelLiveseyy";
...
export default function WhatsNew() {
  return (
    <motion.section
      ...
      initial="hidden"
      whileInView="show"
      className=" mt-0 transition-all duration-300 relative lg:p-4 lg:mt-10"
      id="products"
    >
      ...
      <motion.div className="mt-14 gap-x-10 grid w-full grid-cols-1 px-10 lg:grid-cols-3 lg:px-60">
        ...
        >
          ...
          <div className="flex flex-col  gap-y-4">
            <div className="flex items-center gap-3 justify-center lg:justify-start lg:text-xl">
              <MdBatteryFull />
              <p className={` font-bold lg:text-base`}>3274 mAh Battery</p>
            </div>
            <p className="lg:text-start text-center">
        ...
        >
          ...
          <div className="flex flex-col  gap-y-4">
            <div className="flex items-center gap-3 justify-center lg:justify-start lg:text-xl">
              <BsCpuFill />
              <p className={` font-bold lg:text-base`}>Bionic A17 PRO</p>
            </div>
            <p className="lg:text-start text-center">
          ...
          <div className="flex flex-col  gap-y-4">
            <div className="flex items-center gap-3 justify-center lg:justify-start lg:text-xl">
              <BsFillCloudRainFill />
              <p className={` font-bold lg:text-base`}>IP 68 Water Resistant</p>
            </div>
            <p className="lg:text-start text-center">
