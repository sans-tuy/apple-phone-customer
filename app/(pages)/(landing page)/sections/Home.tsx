...
import { homeData } from "@constanst/data";
  ...
  return (
    <div className="relative">
      <motion.section
        ...
        className="bg-black px-1 lg:px-40 py-8 grid grid-cols-1 transition-all duration-300 lg:p-4 lg:h-[80vh] lg:grid-cols-2"
        id="home"
      >
        <div className="flex flex-col flex-wrap gap-2 lg:max-w-[600px] lg:gap-6">
          <motion.div
            variants={slideInTransition("up", "tween", 1.3, 2)}
            className={`text-white text-base font-semibold text-center lg:text-start`}
          >
            STARTED AT{" "}
        ...
        <motion.div
          variants={slideInTransition("right", "tween", 1.3, 2)}
