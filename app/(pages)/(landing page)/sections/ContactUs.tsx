...
import { openExternalUrl } from "@helpers/index";
            ...
            <div className="flex gap-x-4">
              ...
              <div className="border border-solid border-slate-200 flex flex-col gap-3 w-[180px] h-[130px] rounded-md p-2">
                ...
                <button
                  ...
                  className="p-2 rounded-md border border-black transition-all duration-300 bg-black text-white hover:bg-white hover:text-black hover:solid"
                >
                  Call Now
                </button>
              </div>
